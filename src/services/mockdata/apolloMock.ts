...
import { searchOrder } from "../../graphql/searchOrder";
import QuoteOrderInput from "./json/QuoteOrderInput.json";
import QuoteOrderOutput from "./json/QuoteOrderOutput.json";

import { login } from "../../graphql/authentication";
import { GetJsonOrder } from "../../graphql/tracking";
import { GetCustomerInfo } from "../../graphql/customerPortal";
import GetCustomerInfoOutput from "./json/GetCustomerInfoOutput.json";
import { EOrderStatus } from "../../types/EOrderStatus";
import { getEzShip } from "../../graphql/ezShip";

const LOGIN_SUCCESS = "test";
const LOGIN_FAIL = "test-fail";

export const getDataGetOrder = ({
  orderNumber,
  orderStatus,
...
const getEZShipMock = new Array(5).fill({
  request: {
    query: gql(getEzShip),
    variables: {
      input: {
        UserGUID: "{0C0DEC81-AC49-4532-A4E7-C1EF6040B9D3}",
      },
    },
  },
  result: {
    data: {
      getEzShip: [
        { EZShipId: "NULLPieces", __typename: "EZShipResponse" },
        { EZShipId: "Test 2", __typename: "EZShipResponse" },
        { EZShipId: "Ez Test 1", __typename: "EZShipResponse" },
      ],
    },
  },
});
